...
export default {
    ...
    methods: {
        ...
        getScheduleRule() {
            hospApi.getSchedulePage(this.page, this.limit, this.hoscode, this.depcode).then(response => {
        ...
        //查询第一天的排班详情数据
        getDetail() {
            hospApi.getScheduleDetail(this.hoscode,this.depcode,this.workDate).then(resp=>{
